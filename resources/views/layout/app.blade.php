...
<html lang="en">
  ...
  <head>
   ...
   <!-- Local CSS Files (from public/assets/css folder) -->
<link rel="stylesheet" href="{{ asset('assets/css/fontawesome.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/templatemo-villa-agency.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/owl.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/animate.css') }}">

<!-- External CDN CSS File -->
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="propertysss"><i class="fa fa-calendar"></i>Post Property</a></li>

                      <li>
                          <a href="{{ route('profile.show') }}"
                            style="margin: 0; font-weight: 600; font-size: 16px; color: #2c3e50; text-decoration: none;">
                            👤 {{ Auth::user()->name }}
                          </a>
                      </li>
